      ...
      <div className="w-full flex flex-col items-center justify-center relative">
        ...
        <div className="w-full flex flex-col justify-center sm:pl-16 gap-3 sm:gap-5 text-white absolute top-0 left-0 sm:pt-16 lg:pt-20 pt-4 pl-4 z-10">
          ...
          <p className="text-xs sm:text-base font-normal text-[#000000] drop-shadow">
            ...
            <button className="bg-[#48182E] text-white text-xs mt-0 sm:mt-5 sm:text-sm md:text-base px-4 py-2 rounded-md shadow-md hover:bg-[#6a2545] transition w-fit" onClick={() => window.location.href = '/product?category=necklace'}>
            Shop Now
          </button>
        </div>
